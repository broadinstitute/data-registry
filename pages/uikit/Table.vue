...
const statuses = reactive(['project 1', 'project 3', 'project 4', 'project 2', 'project 5', 'proposal']);
        ...
        <div class="col-12">
            <div class="card">
                ...
                >
                    ...
                    <!-- <Column header="Member" filterField="representative" :showFilterMatchModes="false" :filterMenuStyle="{ width: '14rem' }" style="min-width: 14rem">
                        <template #body="{ data }">
                            <div class="flex align-items-center gap-2">
                    ...
                    <Column field="status" header="Project" :filterMenuStyle="{ width: '14rem' }" style="min-width: 12rem">
                        <template #body="{ data }">
                    ...
                    <Column header="Joined" filterField="date" dataType="date" style="min-width: 10rem">
                        <template #body="{ data }">
