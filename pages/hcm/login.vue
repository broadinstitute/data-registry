...
async function handleLogin() {
  ...
  try {
    const success = await userStore.loginHCM(username.value, password.value);
    
    if (success) {
      // Redirect to intended page or default to HCM home
      const redirectPath = route.query.redirect || '/hcm';
