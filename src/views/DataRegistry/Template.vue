				...
				<div class="card-body dr-form">
					...
					<div class="row dr-data-section">
						...
						<div class="col-md-9">
							...
							<div class="row">
								...
								<div class="col-md-6 col filter-col-md">
									<div class="label">If other ancestry</div>
									<input
										type="text"
										class="form-control input-default"
										placeholder=""
							...
							<div class="row dr-phenotype-samples">
								<div
									class="col-md-12 col filter-col-md selected-phenotypes"
								>
									Type 1 diabetes
								</div>
							...
							<div class="row dr-phenotype-samples">
								...
								<div
									class="offset-md-4 col-md-3 col filter-col-md"
								>
									<div class="label">
										File name<sup>*</sup>
									</div>
					...
					<div class="row dr-credible-set-section">
						<div class="col-md-9">
							...
							<div class="row dr-phenotype-samples">
								<div
									class="offset-md-1 col-md-11 col filter-col-md selected-phenotypes"
								>
									Type 1 diabetes
								</div>
								<div
									class="offset-md-1 col-md-5 col filter-col-md"
								>
									<div class="label">
