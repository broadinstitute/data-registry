        ...
        <template #header>
            <div class="p-4">
                ...
                <p class="text-surface-600 dark:text-surface-400">
                    Create a new user account for HCM GWAS data registry access
                </p>
            </div>
        </template>
            ...
            <form @submit.prevent="handleSubmit" class="space-y-4">
                ...
                <div class="field">
                    ...
                    <small class="text-surface-600 dark:text-surface-400 mt-1 block">
                        <strong>Reviewer:</strong> Can review all uploads, view GWAS summary, create new users<br>
                        <strong>Uploader:</strong> Can upload GWAS files and view their own submissions
                    </small>
                </div>
...
const handleSubmit = async () => {
    ...
    try {
        const result = await userStore.createHCMUser(formData.value, formData.value.userType);
